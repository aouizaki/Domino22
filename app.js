...
valider1.onclick = function calculateResults() {
    ...
    if (totalTeam1 >= 100) {
        ...
        playTextAsAudio(nameteam1 + " gagne le match , Félicitations !!!.");
    }

    if (totalTeam1 > 80) {
        playTextAsAudio( nameteam1 + "Il ne reste plus grand chose, Il reste ," + (100 - totalTeam1) + "Concentre toi" +  nameteam2 + "Malheureusement, vous êtes parmi les morts");
    }
    if (totalTeam2 > 80) {
        playTextAsAudio( nameteam2 + "Il ne reste plus grand chose, Il reste " + (100 - totalTeam1) + ".. Concentre toi" + nameteam1 + "Malheureusement, vous êtes parmi les morts");
    }
    ...
    if (totalTeam1 >= 100) {
        scoretotal.innerText = nameteam1 + " Gagne !!"
        playTextAsAudio(nameteam1 + " Gagne le jeu , Filicitation !!!.");
    };
...
valider2.onclick = function calculateResultsTeam2() {
    ...
    if (totalTeam2 >= 100) {
        ...
        playTextAsAudio(`${nameteam2} " Gagne le jeu , Filicitation . ${nameteam1} a perdu le jeu, essaie la prochaine fois .. bon courage !!."`);
    }
